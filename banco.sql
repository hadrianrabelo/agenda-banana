...
DELETE FROM usuarios WHERE codigoUsuario>4;

CREATE TABLE contatos(
	codigoContato int NOT NULL AUTO_INCREMENT,
    codigoUsuario int NOT NULL,
    nomeContato varchar(100) NOT NULL,
    nascimentoContato date DEFAULT NULL,
    sexoContato enum('M','F') NOT NULL,
    mailContato varchar(100) NOT NULL,
    fotoContato varchar(200) NOT NULL,
    telefone1Contato varchar(15) NOT NULL,
    telefone2Contato varchar(15) NOT NULL,
    telefone3Contato varchar(15) NOT NULL,
    telefone4Contato varchar(15) NOT NULL,
    logradouroContato varchar(150) DEFAULT NULL,
    complementoContato varchar(150) DEFAULT NULL,
    bairroContato varchar(45) DEFAULT NULL,
    estadoContato int DEFAULT NULL,
    cidadeContato int DEFAULT NULL,
...
truncate agenda.usuarios;

CREATE TABLE cidades(

	codigoCidade int NOT NULL AUTO_INCREMENT,
    
    nomeCidade varchar(120) CHARACTER SET latin1 NOT NULL,
...
CREATE TABLE estados(
    ...
    nomeEstado varchar(120) CHARACTER SET latin1 NOT NULL,
    
    siglaEstado varchar(2) CHARACTER SET latin1 NOT NULL,
...
INSERT INTO estados (codigoEstado, nomeEstado, siglaEstado ) VALUES
(1, 'Acre', 'AC'),
(2, 'Alagoas', 'AL'),
(3, 'Amazonas', 'AM'),
(4, 'Amapá', 'AP'),
...
INSERT INTO cidades (codigoCidade, nomeCidade, codigoEstado) VALUES
(1, 'Afonso Cláudio', 8),
